...
const SELF_READ = {
  ...
  3: {
    ...
    B: '你有好感会先观望，怕自作多情。慢热，但一旦认定，比谁都认真。你等的不是人，是「TA也喜欢我」那个确定感。',
...
const WHERE = {
  ...
  C: '踏实的人不爱浪，TA们就在各自的生活圈里。行业活动、读书会、长期运动的小团体、朋友介绍。慢但稳的路子，适合你。',
  D: '你的缘分在「过得好看」的场子里。画展、手作工坊、精致的小酒馆、审美在线的社群。你被氛围吸引，也得去氛围对的地方。',
  E: '你这人哪儿都能遇见。但师傅劝你，别只在日常里打转——换个常去的新店、报个一直想学的课，缘分就从不经意处来。',
}

const PARTNER = {
  A: 'TA是有见识的人，能跟你聊很深的话题，不肤浅。跟TA说话，你觉得脑子被打开，时间过得飞快。',
  B: 'TA有趣、幽默，总能把你带去看新世界。跟TA在一起，日子不重样，永远不会腻。',
  C: 'TA沉稳、靠谱，让你觉得安心。不定时放烟火，但你知道TA一直在。这种踏实，正是你图的。',
  D: 'TA有审美、有品味，把日子过得很漂亮。看TA生活，本身就是种享受。',
  E: 'TA专注在自己热爱的事里，那种「眼里有光」的样子最打动你。TA不一定话多，但认真起来特别迷人。',
}

const TOGETHER = {
  A: '你们是「有来有回」的相处。你主动但不黏，TA也给信号。暧昧期短、确定得快，平时各自精彩，见面就热乎。',
  B: '你们需要一点「确定感」打底。TA得让你知道TA也喜欢你，你才肯全情投入。一旦定了，你比谁都稳。',
